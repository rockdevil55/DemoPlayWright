...
namespace PlaywrightDemo
{
    public class Tests
    {
        ...
        private GenericMethod commonMethods;
        ...
        public async Task Setup()
        {
            ...
            commonMethods = new GenericMethod();
        }
        ...
        private async Task DeleteTeamMemberAsync(int rndNumber)
        {
           ...
           await addTeamMemberPage.ClickDeleteBtnAsync();
            ...
            await Assertions.Expect(expDeleteMessage).ToHaveTextAsync($"Are you sure you want to delete the Team Member Update{firstName}{rndNumber} {lastName}{rndNumber}?");
            ...
            await teamMembersPage.EnterSearchRecordAsync($"{firstName}{rndNumber}");
            var deletedUserNameLocator = teamMembersPage.GetSearchedUser($"{lastName}{rndNumber}, Update{firstName}{rndNumber}");
